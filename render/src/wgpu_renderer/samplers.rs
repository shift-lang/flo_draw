...
impl Samplers {
    ...
    #[inline]
    pub fn default_sampler(&self) -> Arc<wgpu::Sampler> {
        Arc::clone(&self.default_sampler)
    }

    #[inline]
    pub fn non_repeating_sampler(&self) -> Arc<wgpu::Sampler> {
        Arc::clone(&self.non_repeating_sampler)
    }

    #[inline]
    pub fn gradient_sampler(&self) -> Arc<wgpu::Sampler> {
        Arc::clone(&self.gradient_sampler)
    }

    #[inline]
    pub fn non_repeating_gradient_sampler(&self) -> Arc<wgpu::Sampler> {
