        ...
        scene
            .create_entity(TEST_ENTITY, move |_context, mut msg| async move {
                ...
                while let Some(msg) = msg.next().await {
                    ...
                    scene_send(
                        ENTITY_REGISTRY,
                        EntityRegistryRequest::TrackEntities(entity_monitor_channel),
                    )
                    .await
                    .unwrap();
                    ...
                    let expected = vec![hello_entity, add_one_entity, entity_monitor]
                        .into_iter()
                        .collect::<HashSet<_>>();
                    ...
                    while let Some(entity_id) = receiver.next().await {
                        ...
                        if entity_id == hello_entity
                            || entity_id == add_one_entity
                            || entity_id == entity_monitor
                        {
        ...
        scene
            .create_entity(TEST_ENTITY, move |_context, mut msg| async move {
                ...
                while let Some(msg) = msg.next().await {
                    ...
                    let mut hello_channel =
                        scene_send_to::<(String, oneshot::Sender<String>)>(hello_entity).unwrap();
                    ...
                    let send_err = hello_channel
                        .send(("Hello".to_string(), world_sender))
                        .await;
