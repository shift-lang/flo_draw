...
pub const ECHO_ENTITY: EntityId =
    EntityId::well_known(uuid!["D8E25F3A-37C4-431B-B2AB-BFB3C449ECE2"]);
pub const ECHO_ENTITY2: EntityId =
    EntityId::well_known(uuid!["956030EA-2B51-4A28-98E8-646FA7A04192"]);
...
fn echo_scene() -> Scene {
    ...
    scene
        .create_entity(ECHO_ENTITY, |_context, mut msg| async move {
    ...
    scene
        .create_entity(ECHO_ENTITY2, |_context, mut msg| async move {
            let mut receivers = vec![];
...
pub fn complete_recipe() {
    ...
    test_scene_with_recipe(
        scene,
        Recipe::new()
            .expect(vec!["Hello".to_string(), "World".to_string()])
            .after_sending_messages(ECHO_ENTITY, |response_channel| {
                vec![
...
pub fn wait_for() {
    ...
    test_scene_with_recipe(
        scene,
        Recipe::new()
            .wait_for(vec!["Three".to_string(), "Four".to_string()])
            .after_sending_messages(ECHO_ENTITY, |response_channel| {
                vec![
                    EchoRequest::Receive(response_channel),
...
pub fn wait_for_unordered() {
    ...
    test_scene_with_recipe(
        scene,
        Recipe::new()
            .wait_for_unordered(vec!["Four".to_string(), "Three".to_string()])
            .after_sending_messages(ECHO_ENTITY, |response_channel| {
                vec![
                    EchoRequest::Receive(response_channel),
                    EchoRequest::Send("One".to_string()),
...
pub fn send_alongside() {
    ...
    test_scene_with_recipe(
        scene,
        Recipe::new()
            .send_generated_messages(ECHO_ENTITY, || {
                vec![
                    EchoRequest::Send("Hello".to_string()),
                    EchoRequest::Send("World".to_string()),
                    EchoRequest::Done,
            ...
            .alongside_generated_messages(ECHO_ENTITY2, || {
                vec![
                    EchoRequest::Send("Hello".to_string()),
                    EchoRequest::Send("World".to_string()),
                    EchoRequest::Done,
...
pub fn two_expects() {
    ...
    test_scene_with_recipe(
        ...
        Recipe::new()
            .expect(vec!["Hello".to_string(), "World".to_string()])
            .expect(vec!["World".to_string()])
            .after_sending_messages(ECHO_ENTITY, |(channel1, channel2)| {
                vec![
...
pub fn three_expects() {
    ...
    test_scene_with_recipe(
        ...
        Recipe::new()
            ...
            .expect(vec!["Three".to_string(), "Four".to_string()])
            .after_sending_messages(ECHO_ENTITY, |(channel1, channel2, channel3)| {
                vec![
                    EchoRequest::Receive(channel1),
                    EchoRequest::Send("One".to_string()),
                    EchoRequest::Receive(channel2),
...
pub fn four_expects() {
    ...
    test_scene_with_recipe(
        ...
        Recipe::new()
            ...
            .expect(vec!["Three".to_string(), "Four".to_string()])
            .expect(vec!["Four".to_string()])
            .after_sending_messages(ECHO_ENTITY, |(channel1, channel2, channel3, channel4)| {
                vec![
                    EchoRequest::Receive(channel1),
                    EchoRequest::Send("One".to_string()),
                    EchoRequest::Receive(channel2),
...
pub fn fail_wait_for() {
    let scene = echo_scene();
    let failing_recipe = Recipe::new()
        .wait_for(vec!["Four".to_string(), "Three".to_string()])
        .after_sending_messages(ECHO_ENTITY, |response_channel| {
            vec![
                EchoRequest::Receive(response_channel),
                EchoRequest::Send("One".to_string()),
...
pub fn four_fails() {
    ...
    assert!(
        test_result.unwrap_err()
            == RecipeError::ManyErrors(vec![
                RecipeError::UnexpectedResponse,
                RecipeError::UnexpectedResponse,
                RecipeError::UnexpectedResponse,
                RecipeError::UnexpectedResponse
            ])
