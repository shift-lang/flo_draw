        ...
        Self: Mul<Self::Component, Output=Self>,
{
    ...
    #[inline]
    fn source_over(self, dest: Self) -> Self { self.alpha_blend(dest, AlphaOperation::SourceOver) }
    #[inline]
    fn dest_over(self, dest: Self) -> Self { self.alpha_blend(dest, AlphaOperation::DestOver) }
    #[inline]
    fn source_in(self, dest: Self) -> Self { self.alpha_blend(dest, AlphaOperation::SourceIn) }
    #[inline]
    fn dest_in(self, dest: Self) -> Self { self.alpha_blend(dest, AlphaOperation::DestIn) }
    #[inline]
    fn source_held_out(self, dest: Self) -> Self { self.alpha_blend(dest, AlphaOperation::SourceHeldOut) }
    #[inline]
    fn dest_held_out(self, dest: Self) -> Self { self.alpha_blend(dest, AlphaOperation::DestHeldOut) }
    #[inline]
